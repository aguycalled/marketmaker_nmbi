...
* Fixed IDEX minimum ETH wallet check: [#845](https://github.com/bitcoinsfacil/marketmaker_nmbi/issues/845)
* Fixed bug related to paper trading mode account balance: [#843](https://github.com/bitcoinsfacil/marketmaker_nmbi/issues/843)
* Fixed run time warning error when restarting strategy after sending a list config command: [#828](https://github.com/bitcoinsfacil/marketmaker_nmbi/issues/828)
* Fixed bug where trades were not being tracked for a bounty: [#918](https://github.com/bitcoinsfacil/marketmaker_nmbi/issues/918)
* Fixed code bug in DDEX market: [#923](https://github.com/bitcoinsfacil/marketmaker_nmbi/issues/923)
* Fixed pure market making issue with orders getting stuck in client when hanging orders feature is enabled: [#905](https://github.com/bitcoinsfacil/marketmaker_nmbi/issues/905) [#914](https://github.com/bitcoinsfacil/marketmaker_nmbi/issues/914)
