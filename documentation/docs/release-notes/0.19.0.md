...
* Fixed orders getting stuck in Bittrex when hedging price moves too fast: [#1042](https://github.com/bitcoinsfacil/marketmaker_nmbi/issues/1042)
* Fixed issues with starting arbitrage strategy using incorrect trading pair: [#1062](https://github.com/bitcoinsfacil/marketmaker_nmbi/pull/1062)
* Fixed issues when placing orders with extremely low prices on Bittrex: [#1032](https://github.com/bitcoinsfacil/marketmaker_nmbi/issues/1032)
