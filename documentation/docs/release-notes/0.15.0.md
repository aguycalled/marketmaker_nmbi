...
* Fix telegram `history`, which was truncating data: [#743](https://github.com/bitcoinsfacil/marketmaker_nmbi/issues/743)
* Fix cancel/cancel all bug in Huobi connector: [#750](https://github.com/bitcoinsfacil/marketmaker_nmbi/issues/750)
* Increase delay (0.3s to 1s) on Binance snapshot request to avoid rate limit errors
* Fix excessive error warnings in cross exchange market making strategy due to insufficient balance: [#773](https://github.com/bitcoinsfacil/marketmaker_nmbi/issues/773)
